...
console="vnmrs"
   ...
   DefaultLogFile="$gitdir/../logs/gitb12cdoutlog"
...
echo "" | tee -a $log_file
echo "M a k i n g   O p e n V n m r J   B 1 2   D V D   I m a g e" | tee -a $log_file
...
do
      ...
      makeTOC ${dir}.tar $Vnmr  rht/b12.rht
done
  ...
  case x$dir in
   ...
   ;;
      ...
      * )
      ...
      makeTOC ${dir}.tar "$Subject"  rht/b12.rht
   ;;
   esac
done
...
case x$dir in
   ...
   xcode )
      ...
      echo "" | tee -a $log_file
       ...
       cp $gitdir/Notes.txt $gitdir/README.md $dest_dir/.
       chmod 644 $dest_dir/Notes.txt $dest_dir/README.md
...
#       makeTOC jre.tar $Vnmr rht/b12.rht
...
#
   ...
   then
     ...
     cp $gitdir/src/gif/b12.png icon/.
     cd $dest_dir_code/rht
     cp $gitdir/src/gif/installB12 install
